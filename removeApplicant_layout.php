...
<body style=" width:100%; height:100%;">
     <div class="row">
        <div class="col s12">
            <ul style=" color:#009688;margin-top:1.5%; height:51px;width:90.6%;margin-left:4.8%;">
            ...
            <div class='row'>
                <div class='col l4 s12 m4'></div>
					<div class='transbox'>
							...
							<br><br><br>
							<button style='width:40%;margin:0 auto; display:block;' class='btn waves-effect waves-light' type='submit' name='SubmitButton'' value='Submit'>Remove
